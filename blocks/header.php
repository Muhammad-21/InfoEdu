...
<div class="d-flex align-items-center flex-column flex-md-row p-3 px-md-4  shadow-sm">
    ...
    <a target="_blank" class="btn" style="color: white;" href="../users.php">Пользователи</a>
    ...
    <a class="btn" style="color: white; position:absolute; margin-left:40%; bottom:90%;" href="../exit.php">Выход</a>
    </nav>
</div>
</div>